...
## Session Update (2026-06-07) - WiFi Reconfiguration Watchdog (v1.0.7)
...
- **ESP8266 Status**: Verified that the production device `004A936C` (`NLMT_Long`) has been power cycled by the user and is now back online.
